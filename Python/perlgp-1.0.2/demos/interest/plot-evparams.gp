...
set xlabel "tournament" 0.000000,0.000000  ""
...
set tmargin -1
set locale "C"
plot 'results/tournament.log' using 2:9 title "per node mutation probability", '' using 2:11 title "per node crossover probability"
#    EOF
